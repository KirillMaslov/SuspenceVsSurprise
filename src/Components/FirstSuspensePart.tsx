...
const FirstSuspensePart: React.FC<Props> = ({
    gameName,
    numbersArr,
    sumPointsNum,
    setNewPointsSum,
    ...
    return (
        <>
            {part === FirstSuspenceGamePartType.previewText && (
                <>
                    <h1 className='game__start-text subtitle is-uppercase has-text-centered is-size-2 has-text-black mt-4'>suspence</h1>
                    <h1 className='game__start-title subtitle is-uppercase has-text-centered is-size-1 has-text-black'>{gameName}</h1>
                </>
            )}
...
export default FirstSuspensePart;